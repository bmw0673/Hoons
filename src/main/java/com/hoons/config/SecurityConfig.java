...
import com.hoons.jwt.JwtSecurityConfig;
import com.hoons.jwt.JwtAccessDeniedHandler;
import com.hoons.jwt.JwtAuthenticationEntryPoint;
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .sessionManagement(sessionManagement ->
				...
				/*
				 * // enable h2-console .headers(headers ->
